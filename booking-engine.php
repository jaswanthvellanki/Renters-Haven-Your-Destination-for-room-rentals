...
$sql="SELECT * FROM tenant where email='$u_email'";
    ...
    if(mysqli_num_rows($query)>0)
    {
      while ($rows=mysqli_fetch_assoc($query)) {
      	...
      	$sql1="UPDATE add_property SET booked='Pen' WHERE property_id='$property_id'";
...
<div class="alert" role='alert'>
  ...
  <center><strong>Thankyou for booking this property. Your Booking Request is pending from owner End !</strong></center>
</div>
</div>
