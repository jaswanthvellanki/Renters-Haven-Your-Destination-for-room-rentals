...
<nav class="navbar navbar-expand-sm navbar-light justify-content-between" style="background-color: black;">
  <div class="container-fluid">
  <a class="navbar-header" href="index.php">
    <img src="images/KwikrentLogo.png" alt="logo" style="height:60px;">
  </a>
