...
<div class="row">
  ...
  <?php } 
        ...
        <input type="hidden" name="property_id" value="<?php echo $rows['property_id']; ?>">
      <!-- <input type="submit" class="btn btn-lg btn-primary" name="book_Pending" style="width: 100%" value="Booking Pending"> -->
      <input type="submit" class="btn btn-lg btn-primary" style="width: 100%" value="Booking Pending" disabled>
    <?php } 
  else 
  { ?>
